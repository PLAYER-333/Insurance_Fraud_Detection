...
A complete, working fraud-detection pipeline. Primary model is a `RandomForestClassifier`, benchmarked against Logistic Regression and a Decision Tree, trained on `insurance_fraud.csv`.
